      ...
      <div className="flex flex-col gap-10 max-w-5xl mx-auto py-8 animate-in fade-in duration-500">
        ...
        <div className="flex items-center gap-4 glass-subtle rounded-3xl p-5">
          ...
          <div className="flex flex-col">
            <h1 className="font-display text-3xl md:text-4xl font-extrabold text-white tracking-tight drop-shadow-sm">
              Hello, Foodie!
            </h1>
            <p className="text-white/90 font-bold">Here's your taste profile at a glance.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          <div className="glass-subtle rounded-3xl p-6 flex flex-col gap-4">
            ...
            <div>
              <p className="text-sm font-bold text-white/90 uppercase tracking-wider drop-shadow-sm">Recommendations</p>
              <p className="text-4xl font-extrabold text-white mt-1 drop-shadow-sm">{dashboard.totalRecommendations}</p>
            </div>
          </div>
          ...
          <div className="glass-subtle rounded-3xl p-6 flex flex-col gap-4">
            ...
            <div>
              <p className="text-sm font-bold text-white/90 uppercase tracking-wider drop-shadow-sm">Favorites</p>
              <p className="text-4xl font-extrabold text-white mt-1 drop-shadow-sm">{dashboard.totalFavorites}</p>
            </div>
          </div>
          ...
          <div className="glass-subtle rounded-3xl p-6 flex flex-col gap-4 sm:col-span-2 md:col-span-1">
            ...
            <div>
              <p className="text-sm font-bold text-white/90 uppercase tracking-wider drop-shadow-sm">Top Cuisine</p>
              <p className="text-3xl font-extrabold text-white mt-1 line-clamp-1 drop-shadow-sm">
              ...
              {dashboard.topCuisines.slice(0, 5).map((item, index) => {
                ...
                return (
                  <div key={item.cuisine} className="flex items-center gap-4">
                    <div className="w-32 font-bold text-base text-white drop-shadow-sm shrink-0">{item.cuisine}</div>
                    ...
                    <div className="w-8 text-right font-bold text-base text-white/90 drop-shadow-sm">{item.count}</div>
                  </div>
                );
              })}
            </div>
